...
export const tabs = createTabsTokens({
  primary: createTabsPalette({
    ...
    segmentedActiveBorder: withAlpha(colors.primary[600], 0.65),
  ...
  neutral: createTabsPalette({
    ...
    segmentedActiveBg: surface.elevated,
    segmentedActiveBorder: withAlpha(colors.vellira[500], 0.65),
  ...
  success: createTabsPalette({
    ...
    segmentedActiveBg: surface.elevated,
    segmentedActiveBorder: withAlpha(colors.success[600], 0.65),
  ...
  warning: createTabsPalette({
    ...
    segmentedActiveBg: surface.elevated,
    segmentedActiveBorder: withAlpha(colors.warning[600], 0.65),
  ...
  danger: createTabsPalette({
    ...
    segmentedActiveBg: surface.elevated,
    segmentedActiveBorder: withAlpha(colors.error[600], 0.65),
