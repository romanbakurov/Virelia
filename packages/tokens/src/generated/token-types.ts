...
export const componentTokenPaths = [
  ...
  'components.contextMenu.item.focus.ring',
  ...
  'components.contextMenu.trigger.focus.ring',
  ...
  'components.modal.closeButton.focus.ring',
...
export const themeCssVariableNames = [
  ...
  '--context-menu-trigger-focus-ring',
