...
describe('Accordion manual behavior coverage', () => {
  it(
    'provides named, keyboard-native triggers and updates uncontrolled state from keyboard activation',
    async () => {
  ...
  it(
    'keeps controlled state until its value changes and respects disabled state',
    () => {
      const onValueChange = vi.fn();
  ...
  it(
    'keeps trigger/content relationships unique across Accordion instances and stable across rerenders',
    () => {
