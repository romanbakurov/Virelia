...
const reactRadioApi: readonly ComponentApiProp[] = [
  {
    name: 'label',
    type: 'ReactNode',
  ...
  },
  {
    name: 'form',
    type: 'string',
    description: 'Forwarded React DOM prop for Radio.',
  },
  {
    name: 'slot',
    type: 'string',
...
const nativeRadioApi: readonly ComponentApiProp[] = [
  {
    name: 'label',
    type: 'ReactNode',
    description: 'Visible label rendered next to the control.',
  ...
  },
  {
    ...
    type: '((event: GestureResponderEvent) => void)',
    description: 'Forwarded React Native prop for Radio.',
  },
  {
